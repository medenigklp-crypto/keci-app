...
/* ═══════════════════════════════════════════════════════════════
   İKONLAR — dış paket yok, hepsi burada. Uyumluluk sorunu çıkmaz.
   ═══════════════════════════════════════════════════════════════ */

const mkIcon = (paths) =>
  function Icon({ size = 20, color = "currentColor", strokeWidth = 1.9, className, style }) {
    return (
      <svg
        width={size}
        height={size}
...
const Plus = mkIcon(<path d="M12 5v14M5 12h14" />);
const X = mkIcon(<path d="M18 6 6 18M6 6l12 12" />);
...
const Send = mkIcon(<path d="M22 2 11 13M22 2l-7 20-4-9-9-4 20-7Z" />);
...
const BookOpen = mkIcon(
  <>
    <path d="M2 4h6a3 3 0 0 1 3 3v13a2.5 2.5 0 0 0-2.5-2H2V4Z" />
    <path d="M22 4h-6a3 3 0 0 0-3 3v13a2.5 2.5 0 0 1 2.5-2H22V4Z" />
  </>
);
...
const Loader2 = mkIcon(<path d="M21 12a9 9 0 1 1-6.2-8.6" />);
